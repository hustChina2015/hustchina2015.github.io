...
$(document).ready(function () {
	...
	parallax.index.onload=function(){
		setRight("team","Acknowledgment");
		setLeft("abstract", "Abstract");
		setBottom("video","Video");
	};
	...
	parallax.abstract.onload=function(){
		setLeft("team","Acknowledgment");
		setRight("index", "Home");
	};

	parallax.team.onload=function(){
		setLeft("index","Home");
		setRight("abstract", "Abstract");
	};
